...
class Wav2VecAlignment:
    ...
    def __init__(self, device='cuda' if not torch.backends.mps.is_available() else 'mps'):
        self.model = Wav2Vec2ForCTC.from_pretrained("/Users/zhangsan/Downloads/wav2vec2-large-robust-ft-libritts-voxpopuli").cpu()
        self.feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained(f"/Users/zhangsan/Downloads/wav2vec2-large-960h")
        self.tokenizer = Wav2Vec2CTCTokenizer.from_pretrained('/Users/zhangsan/Downloads/tacotron-symbols')
        self.device = device
